  ...
  render() {
    ...
    return (
      <ContentContainer width={width} height={height}>
        <ContentTitle>{translator.t('Cấu hình dự án')}</ContentTitle>

        <form onSubmit={e => this.onSubmit(e)}>
          <FormBlock>
            <FormLabel htmlFor='width'>{translator.t('Chiều rộng')}</FormLabel>
            <FormNumberInput
              id='width'
              placeholder='width'
              value={dataWidth}
          ...
          <FormBlock>
            <FormLabel htmlFor='height'>{translator.t('Chiều cao')}</FormLabel>
            <FormNumberInput
              id='height'
              placeholder='height'
              value={dataHeight}
            ...
            <tr>
              <td>
                <CancelButton size='large'
                              onClick={e => projectActions.rollback()}>{translator.t('Hủy')}</CancelButton>
              </td>
              <td>
                <FormSubmitButton size='large'>{translator.t('Lưu')}</FormSubmitButton>
              </td>
            </tr>
            </tbody>
          </table>
