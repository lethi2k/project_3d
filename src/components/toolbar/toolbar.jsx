    ...
    let sorter = [
      {
        index: 0, condition: allowProjectFileSupport, dom: <ToolbarButton
          active={false}
          tooltip={translator.t('Tạo mới')}
          onClick={event => confirm(translator.t('Bạn có muốn bắt đầu Tạo mới?')) ? projectActions.newProject() : null}>
          <FaFile />
        </ToolbarButton>
      },
      {
      ...
      },
      {
        ...
        dom: <ToolbarButton
          ...
          tooltip={translator.t('Mở danh mục')}
      ...
      },
      {
        index: 4, condition: true, dom: <ToolbarButton
          ...
          tooltip={translator.t('Xem chế độ 3d')}
      ...
      },
      {
        index: 5, condition: true, dom: <ToolbarButton
          ...
          tooltip={translator.t('Xem chế độ 2d')}
      ...
      },
      {
        index: 6, condition: true, dom: <ToolbarButton
          ...
          tooltip={translator.t('3D hiện thị 360')}
      ...
      },
      {
        index: 7, condition: true, dom: <ToolbarButton
          active={false}
          tooltip={translator.t('Trở lại (CTRL-Z)')}
      ...
      },
      {
        index: 8, condition: true, dom: <ToolbarButton
          ...
          tooltip={translator.t('Cấu hình dự án')}
